...
<section class="content">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">PUBLISH VIDEO TO YOUR FACEBOOK GROUPS</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
    ...
    @endif
              <form role="form" action="{{ route('pvideo.store') }}" enctype="multipart/form-data" method="post">
                 @csrf
                <div class="card-body">
                   ...
                   <a href="#" class="btn btn-block btn-primary">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="video" value="video" class="custom-file-input" id="exampleInputFile">
