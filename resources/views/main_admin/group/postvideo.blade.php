...
<section class="content">
    ...
    @endif
              <form role="form" action="{{ route('gvideo.store') }}" enctype="multipart/form-data" method="post">
                 @csrf
                <div class="card-body">
                   ...
                   <a href="#" class="btn btn-block btn-primary">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="video" name="video" value="video" class="custom-file-input" id="exampleInputFile">
